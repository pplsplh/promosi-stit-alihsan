...
export default function HeroSection() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ background: 'linear-gradient(135deg, #0a1a0f 0%, #1B4332 40%, #0a1a0f 100%)' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              >
                <GraduationCap size={20} color="#0a1a0f" strokeWidth={2.5} />
              </div>
            </div>
            <div>
        ...
        {menuOpen && (
          <div className="md:hidden px-6 pb-4 flex flex-col gap-4" style={{ background: 'rgba(10,22,40,0.97)' }}>
            ...
            <a
              ...
              style={{ background: 'linear-gradient(135deg, #C9A84C, #8B6914)', color: '#0a1a0f' }}
            >
              Daftar Sekarang
            </a>
          </div>
